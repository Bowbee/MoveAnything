...
local m = {
	...
	LoadList = function(self)
		...
		API:AddElement({name = "QueueStatusButton", displayName = "Battleground Minimap Button"}, c)
		...
		API:AddElement({name = "StatusTrackingBarManager", displayName = "XP/Reputation bar"}, c)
		...
		API:AddElement({name = "QueueStatusButton", displayName = "Dungeon Status Button"}, c)
